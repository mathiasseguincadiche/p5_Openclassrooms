...
show_main_menu() {
    ...
    show_menu "MENU PRINCIPAL" \
        ...
        "1:Exercice 1 - Terraform + Ansible + Angular (Phase 1)" \
...
run_phase_1() {
    title "PHASE 1 : EXERCICE 1 - TERRAFORM + ANSIBLE + ANGULAR"
    info "Ce script va déployer 2 VMs AWS avec NGINX + Application Angular."
