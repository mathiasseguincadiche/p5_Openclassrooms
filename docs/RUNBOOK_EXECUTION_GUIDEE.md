...
## 3. Vérifier la plateforme amont
...
## 6. Mettre le dépôt P5 à disposition
...
## 9. Lancer le parcours complet

```bash
bash scripts/commands/p5.sh all
```

Le centre de commande enchaîne :
...
## 15. Après fermeture du terminal ou redémarrage Windows
