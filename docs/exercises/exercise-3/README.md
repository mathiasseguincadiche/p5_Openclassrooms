...
[webservers]
ansible-node-1 ansible_host=localhost ansible_port=2221 ansible_user=root ansible_password=password
ansible-node-2 ansible_host=localhost ansible_port=2222 ansible_user=root ansible_password=password
...
# - ansible_user : Utilisateur SSH (par défaut : root).
