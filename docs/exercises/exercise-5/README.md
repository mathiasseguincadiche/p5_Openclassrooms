...
data:
  # Encoder "mon-mot-de-passe" en base64 : echo -n "mon-mot-de-passe" | base64
  NGINX_PASSWORD: bW9uLW1vdC1kZS1wYXNzZQ==

# =============================================
# Explications :
# - kind : Secret (pour stocker des données sensibles).
# - type : Type de secret (Opaque, kubernetes.io/tls, etc.).
# - data : Données du secret (doivent être encodées en base64).
...
> **✅ Résultat attendu** :
> - Les **variables d'environnement** devraient inclure `NGINX_ENV=production` et `NGINX_PASSWORD=mon-mot-de-passe`.
